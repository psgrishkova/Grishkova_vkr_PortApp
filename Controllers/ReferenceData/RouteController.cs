...
namespace Grishkova_vkr_PortApp.Controllers.ReferenceData
{
    ...
    {
        private vpdbDataSetTableAdapters.МаршрутTableAdapter adapter;
        private vpdbDataSet.МаршрутDataTable table;

        public RouteController(vpdbDataSetTableAdapters.МаршрутTableAdapter маршрутTableAdapter, vpdbDataSet.МаршрутDataTable маршрут)
        {
