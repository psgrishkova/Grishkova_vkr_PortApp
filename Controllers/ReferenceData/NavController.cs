...
namespace Grishkova_vkr_PortApp.Controllers.ReferenceData
{
    class NavController : CRUDController
    {
        ...
        private vpdbDataSetTableAdapters.НавигацияTableAdapter adapter;
        private vpdbDataSet.НавигацияDataTable table;

        public NavController(System.ComponentModel.Component adapter, System.Data.DataTable table)
        {
            this.adapter = (vpdbDataSetTableAdapters.НавигацияTableAdapter)adapter;
            this.table = (vpdbDataSet.НавигацияDataTable)table;
            fill();
        }
        public void add(object[] data)
        {
            if(((string)data[0]).Equals(""))
